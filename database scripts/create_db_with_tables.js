...
connection.connect(function (err) {
  ...
  const CREATE_TASK_TABLE_QUERY = `CREATE TABLE IF NOT EXISTS ${dbName}.task ( taskId int NOT NULL AUTO_INCREMENT, title varchar(255) NOT NULL, completionStatus int DEFAULT 0, scheduledStatus int DEFAULT 0, PRIMARY KEY (taskId));`;
